...
public class JRubyEngineTest {
    ...
    public void testPathTyp() throws BSFException {
        ...
        BSFManager manager = new BSFManager();
        JRubyEngine instance = (JRubyEngine) manager.loadScriptingEngine("jruby");
        Object receiver = instance.eval("ruby/radioactive_decay.rb", 0, 0, PathType.CLASSPATH);
    ...
    public void testRubyVersion() throws BSFException {
        ...
        BSFManager manager = new BSFManager();
        JRubyEngine instance = (JRubyEngine) manager.loadScriptingEngine("jruby");
        Object result = instance.eval("ruby/block-param-scope.rb", 0, 0, PathType.CLASSPATH);
        ...
        result = instance.eval("ruby/block-param-scope.rb", 0, 0, PathType.CLASSPATH);
        expResult = "bear";
        assertEquals(expResult, ((String)result).trim());
    }
